...
print(myList[7:2:-1]) # [8, 7, 6, 5, 4]


# # print myList from index 3 to end
# # print(myList[3:])
# # print myList from index 0 to 6 with step size is 2
# # print(myList[0:6:2])
# # A different way
# # print(myList[::2])

# # New list from 0 to 100

# # myNewList = list(range(100))
# # print(myNewList)
# # print(myNewList[::10])
# # print(myNewList[::-10]) 
